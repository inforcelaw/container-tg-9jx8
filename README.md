...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-tg-9jx8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-tg-9jx8.containers.anotherwebservice.com/
...
```
git clone git@github.com:inforcelaw/container-tg-9jx8.git
cd container-tg-9jx8
```
...
```
docker attach container-tg-9jx8
```
